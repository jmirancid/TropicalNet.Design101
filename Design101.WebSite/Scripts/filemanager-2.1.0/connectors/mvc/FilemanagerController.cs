...
namespace Design101.WebSite.Scripts.Filemanager.Connectors.Mvc
{
    /// <summary>
    /// Filemanager controller
    /// </summary>
    public abstract class FilemanagerController : Controller
    {
        /// <summary>
        ...
        private List<string> allowedExtensions =
            new List<string> { ".ai", ".asx", ".avi", ".bmp", ".csv", ".dat", ".doc", ".docx", ".epub", ".fla", ".flv", ".gif", ".html", ".ico", ".jpeg", ".jpg", ".m4a", ".mobi", ".mov", ".mp3", ".mp4", ".mpa", ".mpg", ".mpp", ".pdf", ".png", ".pps", ".ppsx", ".ppt", ".pptx", ".ps", ".psd", ".qt", ".ra", ".ram", ".rar", ".rm", ".rtf", ".svg", ".swf", ".tif", ".txt", ".vcf", ".vsd", ".wav", ".wks", ".wma", ".wmv", ".wps", ".xls", ".xlsx", ".xml", ".zip" }; // Only allow these extensions to be uploaded

        public virtual List<string> AllowedExtensions
        {
            get
            {
        ...
        private List<string> imgExtensions =
            new List<string> { ".jpg", ".png", ".jpeg", ".gif", ".bmp" }; // Only allow this image extensions. [string]

        public virtual List<string> ImgExtensions
        {
            get
            {
        ...
        /// <returns></returns>
        public virtual ActionResult Index(string mode, string path = null)
        {
        ...
        {
            return path != null && Server.MapPath(path).StartsWith(Server.MapPath(RootPath));
        }
        ...
        /// <param name="path"></param>
        /// <returns></returns>
        public virtual string AddFile(string path)
        {
            string response;
        ...
        /// <returns></returns>
        public virtual string AddFolder(string path, string newFolder)
        {
            if (!IsInRootPath(path))
            {
        ...
        /// <param name="path"></param>
        /// <returns></returns>
        public virtual string GetFolderInfo(string path)
        {
            if (!IsInRootPath(path))
            {
        ...
        /// <param name="path"></param>
        /// <returns></returns>
        public virtual string GetInfo(string path)
        {
            if (!IsInRootPath(path))
            {
        ...
        public virtual string Move(string oldPath, string newPath)
        {
        ...
        /// <param name="path"></param>
        /// <returns></returns>
        public virtual string Replace(string path)
        {
            if (Request.Files.Count == 0 || Request.Files[0].ContentLength == 0)
            {
        ...
        public virtual ActionResult Download(string path)
        {
            if (System.IO.File.Exists(Server.MapPath(path)) && IsInRootPath(path))
            {
                ...
                Response.AddHeader("Content-Disposition", "attachment; filename=" + Server.UrlPathEncode(fi.FullName));
        ...
        {
            var fi2 = new FileInfo(Server.MapPath(path));
